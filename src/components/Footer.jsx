      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start justify-between gap-12">
        ...
        <div className="flex flex-1 flex-row flex-wrap md:flex-nowrap justify-between w-full md:w-[60%] gap-8">
          ...
          <div className="min-w-[120px]">
            <h3 className="text-white font-serif text-[20px] font-bold mb-8 italic">
              {" "}
              Resources{" "}
            </h3>
          ...
          <div className="min-w-[200px]">
            <h3 className="text-white font-serif text-[20px] font-bold mb-8 italic underline decoration-orange-500/40 underline-offset-8">
              About Developer
            </h3>
