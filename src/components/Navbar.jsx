  ...
  return (
    <nav style={{
      ...
      <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: '15px', textDecoration: 'none' }}>
        <img src="/logo.png" alt="PawAlert" style={{ height: '48px' }} />
        <span style={{ fontSize: '1.8rem', fontWeight: 900, color: '#f9f7f2', letterSpacing: '-1.5px' }}>PawAlert</span>
      </Link>

      <div style={{ display: 'flex', alignItems: 'center', gap: '35px' }}>
        <Link to="/dashboard" style={{ color: '#fff', textDecoration: 'none', fontWeight: 700 }}>Dashboard</Link>
        <Link to="/support" style={{ color: '#fff', textDecoration: 'none', fontWeight: 700 }}>Support</Link>

        {token ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            <span style={{ color: '#f59e0b', fontWeight: 800 }}>[{user?.role?.toUpperCase() || 'USER'}]</span>
