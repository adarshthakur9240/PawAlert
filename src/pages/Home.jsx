    ...
    <div className="bg-[#020617] scroll-smooth min-h-screen">
      ...
      <section className="animate-gradient relative flex flex-col items-center pt-44 md:pt-56 pb-32 px-6 overflow-hidden min-h-screen justify-start">
        <div className="flex flex-col items-center text-center z-10">
          ...
          <div className="flex flex-col md:flex-row gap-5 mt-12 w-full md:w-auto px-6">
            <button
              ...
              className="bg-orange-600 hover:bg-orange-500 text-white px-10 py-4 rounded-2xl font-black text-lg flex items-center justify-center gap-3 transition-all transform hover:scale-105 active:scale-95 shadow-2xl shadow-orange-600/40"
            >
              Start Reporting <ArrowRight size={22} />
            </button>
            <button className="bg-white/5 border border-white/10 text-white px-10 py-4 rounded-2xl font-black text-lg transition hover:bg-white/10 backdrop-blur-md">
              Watch Demo
            </button>
          </div>
        </div>
        ...
        <div className="mt-32 w-full max-w-5xl flex flex-col items-center opacity-50 grayscale hover:grayscale-0 transition-all duration-700 text-white z-10 px-4">
          <p className="text-[10px] font-black uppercase tracking-[0.4em] mb-12 text-orange-500/80 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-10 md:gap-24">
            ...
            <div className="text-xl font-black tracking-tighter uppercase opacity-80">
              Municipal Corp.
            </div>
          </div>
        </div>
