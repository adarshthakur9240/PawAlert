    ...
    <div className="flex h-screen w-full bg-[#050505] font-['Inter']">
      ...
      <div className="w-full hidden md:block relative overflow-hidden">
        ...
        <div className="absolute bottom-12 left-12 z-20">
          ...
          <p className="text-zinc-400 mt-4 max-w-sm font-medium italic">
      ...
      <div className="w-full flex flex-col items-center justify-center p-8 lg:p-16">
        <form className="w-full max-w-[400px] flex flex-col">
          ...
          <div className="grid grid-cols-2 gap-4 mt-8">
            <button
              type="button"
              className="flex items-center justify-center h-14 rounded-2xl bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 transition-all gap-2"
            >
              <img
          ...
          <div className="space-y-4">
            <div className="flex items-center w-full bg-zinc-900 border border-zinc-800 h-14 rounded-2xl px-6 gap-3 focus-within:border-orange-500/50 transition-all">
              <i className="fa-solid fa-envelope text-zinc-500"></i>
              <input
                type="email"
                placeholder="Email id"
                className="bg-transparent text-white placeholder-zinc-600 outline-none text-sm w-full font-medium"
                required
              />
            </div>
          ...
          <div className="w-full flex items-center justify-between mt-6">
            ...
            <a
              className="text-sm text-orange-500 font-bold hover:text-orange-400 underline decoration-2 underline-offset-4"
              href="#"
            >
              Forgot password?
            </a>
          ...
          <button
            type="submit"
            className="mt-10 w-full h-14 rounded-2xl text-black bg-orange-500 font-black text-lg hover:scale-[1.02] active:scale-95 transition-all shadow-[0_10px_40px_rgba(249,115,22,0.2)]"
          >
            Login to Mission 🐾
          </button>
