      ...
      <div className="w-full flex flex-col items-center justify-center p-8 lg:p-16">
        ...
        >
          ...
          <div className="flex items-center gap-4 w-full my-8">
            ...
            <p className="text-[10px] font-black text-zinc-600 uppercase tracking-widest text-nowrap">
              Or login with email
            </p>
            <div className="flex-1 h-px bg-zinc-800"></div>
          </div>
          ...
          <div className="space-y-4">
            <input
              ...
              className="w-full bg-zinc-900 border border-zinc-800 h-14 rounded-2xl px-6 text-white placeholder-zinc-600 outline-none focus:border-orange-500/50 transition-all font-medium"
              required
            />
            <input
              type="password"
