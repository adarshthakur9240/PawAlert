        ...
        <section id="about" className="flex flex-col md:flex-row items-center justify-center gap-16 py-24 px-6 md:px-20 bg-[#050505]">
            <div className="relative shadow-2xl shadow-orange-600/20 rounded-[2.5rem] overflow-hidden shrink-0">
                ...
                <div className="flex items-center gap-4 max-w-72 absolute bottom-8 left-8 bg-[#0a0a0a] border border-zinc-800 p-5 rounded-2xl shadow-2xl">
                    <div className="flex items-center justify-center text-[10px] font-black text-white size-10 rounded-full bg-orange-500">1K+</div>
                    <p className="text-xs font-bold text-zinc-300">Join our tribe</p>
                </div>
            </div>
            <div className="text-zinc-400 max-w-lg">
                ...
                <h2 className="text-4xl md:text-5xl font-black text-white mt-8 leading-tight">Every street life deserves a <span className="text-orange-500">savior.</span></h2>
                <button className="mt-10 bg-orange-500 py-4 px-10 rounded-2xl text-black font-black text-sm uppercase">Our Mission</button>
            </div>
        </section>
    );
}
